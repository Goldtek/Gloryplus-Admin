...
<!-- Footer --> */}
                    <div className="legal">
                        <div className="copyright">
                            &copy; {(new Date().getFullYear())} <a href="http://www.gloryplusinternational.org/" target="_blank" rel="noopener noreferrer">Glory Plus Admin</a>.
</div>
...
<!-- Right Sidebar --> */}
                <aside id="rightsidebar" className="right-sidebar">
                    ...
                    <div className="tab-content">
                        ...
                        <div role="tabpanel" className="tab-pane fade in active in active" id="settings">
