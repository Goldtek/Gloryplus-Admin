    ...
    <nav className="navbar">
      <div className="container-fluid">
        <div className="navbar-header">
          ...
          <a className="navbar-brand" href="/"><b>Admin - Glory Plus</b></a>
        </div>
        <div className="collapse navbar-collapse" id="navbar-collapse">
          <ul className="nav navbar-nav navbar-right">
            {/* <!-- Call Search --> */}
            <li><a href="#;" className="js-search" data-close="true"><i
...
<!-- Tasks --> */}
        ...
        <small>32%</small>
                        ...
                        <div className="progress">
                          <div className="progress-bar bg-pink" role="progressbar" aria-valuenow="85"
        ...
        <small>45%</small>
                        ...
                        <div className="progress">
                          <div className="progress-bar bg-cyan" role="progressbar" aria-valuenow="85"
        ...
        <small>54%</small>
                        ...
                        <div className="progress">
                          <div className="progress-bar bg-teal" role="progressbar" aria-valuenow="85"
        ...
        <small>92%</small>
            ...
            {/* <!-- #END# Tasks --> */}
            <li className="pull-right"><a href="#;" className="js-right-sidebar" data-close="true"><i
              className="material-icons">more_vert</i></a></li>
          </ul>
        </div>
      </div>
    </nav>
